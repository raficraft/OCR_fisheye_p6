...
class Carousel {
  ...
  constructor(element, options = {}) {
    ...
    this.btn.prev.addEventListener("click", (e) => {
      e.stopPropagation();
      this.prev();
    });
  ...
  goToItem(index) {
    if (index < 0) {
      ...
      this.item[this.currentItem + this.options.slidesVisible] === "undefined"
    ) {
      index = 0;
    }
    ...
    this.options.imgView = document.querySelector(
      `.slider [data-inc="${this.options.currentItem}"]`
    );
  }
